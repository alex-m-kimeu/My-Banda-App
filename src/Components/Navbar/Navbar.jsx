              ...
              <div className="hidden sm:ml-6 sm:block  -mr-4  ">
                <div className="flex space-x-2 mt-3">
                  ...
                  <NavLink to="/buyer/wishlist" className='relative text-gray-700 rounded-md px-3 py-2 text-sm font-medium '>
                     ...
                     {wishlistNum > 0 ?   <div className='bg-Secondary hover:text-black flex justify-center justify-items-center place-content-center  items-cent h-4 absolute top-0 right-0 -mr-1 text-[8px]  rounded-full p-1 '>
                  ...
                  <NavLink to="/buyer/cart" className='relative text-gray-700 rounded-md px-3 py-2 text-sm font-medium '>
                   ...
                   {cartNum > 0 ?   <div className='bg-Secondary hover:text-black flex justify-center justify-items-center place-content-center  items-cent h-4 absolute top-0 right-0 -mr-1 text-[8px]  rounded-full p-1 '>
                      <div className=' self-center'>
                      {cartNum}
                      </div>
                     </div>: <div></div>
                  ...
                  >
                   ...
                   <MenuItem className='sm:hidden block'>
                       ...
                       >
                         ...
                         <div className='flex '>
                         <span className='mr-2'>My Cart </span>{cartNum >0?<div className='text-xs flex justify-center w-3 bg-Secondary rounded-full px-2 bg- self-center'>{cartNum}</div> : <div></div>}
                         </div>
                         </div>
                       </NavLink>

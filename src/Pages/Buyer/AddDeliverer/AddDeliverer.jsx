      ...
      <div className="">
        <div className="flex justify-between ">
          <form action="" className="flex" onSubmit={handleSubmitLocation}>
            <div className="flex">
              <FaLocationDot className=" h-10 bg-gray-100 w-10 p-2 rounded-l" />
              <input
                type="text"
                className="bg-gray-100 rounded-r focus:outline-none py-1 px-1"
                id="location"
            ...
            {companies.map((company) => (
              ...
              >
                <div className=" flex flex-col content-between  place-content-between">
                  <div>
                    ...
                    <div className="max-w-96 ">
                      {" "}
                      <p className="text-sm text-Variant2 ">
                        {company.description}
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  />
                  <button
                    className="transform transition duration-200 hover:scale-105 focus:bg-Secondary hover:bg-Secondary hover:bg-opacity-10 text-xs focus:bg-opacity-40 focus bg-White shadow px-2 py-1 rounded bg-opacity-30 absolute bottom-5 right-5"
                    onClick={() => HandleAddDeliverer(company.id)}
                  >
                    Choose Deliverer
                  </button>
                </div>

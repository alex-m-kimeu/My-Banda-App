...
<div className='hidden md:block '>
    <input type="text" placeholder="Coupon Code" className='focus:border-Secondary border px-4 py-2 mr-4 rounded border-gray-300' />
    <button className='bg-Secondary text-white px-6 py-2 rounded'>Apply Coupon</button>
</div>
 <div className='  border rounded border-gray-300 p-3 px-5 py-5 md:w-80 divide-y w-full'>
   ...
   <div className='flex justify-center'>
     <button className='text-white px-6 py-2 mt-5 bg-Secondary rounded'> Process to Checkout</button>
   </div>

  ...
  return (
    <div className="bg-Primary font-body text-Text min-h-screen">
      <main className="p-4 md:p-8 lg:p-12">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-center">Jewelry</h1>
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-4">Rings</h2>

        ...
        <div className="flex flex-col lg:flex-row items-start">
            <div className="lg:w-1/2">
                ...
                {storeName ? (
                        ...
                        <div className="rounded-md p-6 shadow-md mb-4 mt-6 ml-8 mr-6 flex items-center lg:w-90">
                            <div className="mr-4 flex-grow">
                                <div>
                                    ...
                                    <p className="text-lg text-Secondary text-center">{seller}</p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className="rounded-md p-6 shadow-md mb-4 mt-6 ml-8 mr-6">
                            <p className="text-base">You don't have a store yet.</p>
                            <p className="text-base">Create a store to start selling your products.</p>
                            <button onClick={() => navigate('/seller/store')} className="bg-Secondary text-Primary py-2 px-4 rounded">
                                Go to Store
                            </button>
                        </div>
                    </div>

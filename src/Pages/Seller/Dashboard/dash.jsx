                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 m-4'>
                    <div className='flex flex-col justify-between w-full md:w-auto h-48 bg-yellow-500 p-4 rounded-md'>
                        <div className='flex w-full items-center justify-between'>
                            <div><BsAlexa className='text-4xl text-black' />$50,634.00</div>
                            <div className='flex items-center justify-center w-10 h-10 text-black bg-white rounded-full'><CiMenuKebab /></div>
                        </div>
                        <div className='font-extrabold text-4xl sm:text-2xl md:text-lg lg:text-xl text-black'>Sales</div>
                        <div>
                    ...
                    <div className='flex flex-col justify-between w-full md:w-auto h-48 bg-yellow-500 p-4 rounded-md'>
                        <div className='flex w-full items-center justify-between'>
                            <div><FaUsers className='text-4xl text-black' />50+</div>
                            <div className='flex items-center justify-center w-10 h-10 text-black bg-white rounded-full'><CiMenuKebab /></div>
                        </div>
                        <div className='font-extrabold text-4xl sm:text-2xl md:text-lg lg:text-xl text-black'>Customers</div>
                        <div>
                    ...
                    <div className='flex flex-col justify-between w-full md:w-auto h-48 bg-yellow-500 p-4 rounded-md'>
                        <div className='flex w-full items-center justify-between'>
                            <div><IoIosFlash className='text-4xl text-black' />3500+</div>
                            <div className='flex items-center justify-center w-10 h-10 text-black bg-white rounded-full'><CiMenuKebab /></div>
                        </div>
                        <div className='font-extrabold text-4xl sm:text-2xl md:text-lg lg:text-xl text-black'>Orders</div>
                        <div>
                    ...
                    <div className='flex flex-col justify-between w-full md:w-auto h-48 bg-white shadow-md p-4 rounded-md'>
                        <div className='flex w-full items-center justify-between'>
                            <div><BsPersonVcard className='text-4xl text-black' />-1000</div>
                            <div className='flex items-center justify-center w-10 h-10 text-black bg-gray-300 rounded-full'><CiMenuKebab /></div>
                        </div>
                        <div className='font-extrabold text-4xl sm:text-2xl md:text-lg lg:text-xl text-black'>Expenses</div>
                        <div>
                            <div className='text-black text-sm font-semibold'>This Week card processing</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='col-span-4 md:col-span-1 h-28 bg-yellow-500 rounded-md'>
                        <div className='flex flex-col justify-between p-4 h-full'>
                            ...
                            <div className='flex items-center justify-between w-full'>
                                <div className='text-5xl sm:text-xl md:text-xl lg:text-5xl font-bold text-black'>+64</div>
                    ...
                    <div className='col-span-4 md:col-span-1 h-28 bg-yellow-500 rounded-md'>
                        <div className='flex flex-col justify-between p-4 h-full'>
                            ...
                            <div className='flex items-center justify-between w-full'>
                                ...
                                <div className='flex px-2 py-1 text-xs rounded-full bg-red-500 items-center justify-center text-red-900'>19%</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-col m-4'>
                    ...
                    <div className='flex flex-col gap-6 p-4 m-4 rounded-md h-auto shadow-lg'>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <div className='font-semibold text-black text-sm'>4-5 business days</div>
                        </div>
                        <div>
                            <button className='bg-gradient-to-tr from-yellow-500 to-black text-white p-4 w-full rounded-xl'>View Status</button>
                        </div>
                    </div>

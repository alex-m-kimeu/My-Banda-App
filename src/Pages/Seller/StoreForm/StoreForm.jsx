    ...
    <div className="flex justify-center lg:justify-start min-h-screen p-4 ">
      <div className=" max-w-md w-full">
        <form onSubmit={handleSubmit} className="bg-Primary ">
          ...
          <h3 className="text-lg text-start font-bold mb-4 text-Variant">Information</h3>
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex justify-start space-x-6">
              ...
              <button
                type="button"
                className="bg-Secondary hover:bg-Primary text-Primary hover:text-Variant font-semibold py-2 px-4  focus:outline-none focus:shadow-outline"
                onClick={() => {
                  setFormData({
                    store_name: '',
                    description: '',
